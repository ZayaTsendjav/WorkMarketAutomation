...
public class UserLogin extends Util {
    ...
    @FindBy(how = How.XPATH,using = "//body[contains(@class,'page-search')]/div[contains(@class,'open')]/header[@id='wm-main-nav']/div[contains(@data-radium,'true')]/div/button[contains(@type,'button')]/div/*[1]")
